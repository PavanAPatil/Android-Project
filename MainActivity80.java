...
ImageButton im1,im2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        im1=(ImageButton)findViewById(R.id.imageButton25);
        im2=(ImageButton)findViewById(R.id.imageButton26);
        im1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i=new Intent(getApplicationContext(),MainActivity81.class);
                startActivity(i);
            }
        });
        im2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i=new Intent(getApplicationContext(),MainActivity82.class);
                startActivity(i);
            }
        });
    }
